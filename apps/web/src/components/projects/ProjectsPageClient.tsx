        ...
        <div className="flex gap-2">
          ...
          {isAdmin && (
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-sd4a-dark text-white rounded-lg text-sm font-medium hover:bg-[#075e69] transition-colors"
            >
      ...
      <div className="flex gap-3 flex-wrap items-center">
        <div className="relative">
          ...
          <input
            ...
            className="pl-9 pr-8 py-2 border border-border rounded-lg text-sm bg-background focus:outline-none focus:ring-2 focus:ring-sd4a-mid/50 focus:border-sd4a-mid w-72 text-foreground"
          />
          {search && (
